...
#                 data.mcmc_parameters['c1']['scale'])
	...
	fNL = 0.
        ...
        fNL2 = (data.mcmc_parameters['f^{(2)}_{NL}']['current'] *
                 data.mcmc_parameters['f^{(2)}_{NL}']['scale'])


#        lncs = (data.mcmc_parameters['lncs']['current'] *
#                 data.mcmc_parameters['lncs']['scale'])
#        c3 = (data.mcmc_parameters['c3']['current'] *
#                 data.mcmc_parameters['c3']['scale'])
#        fNL = 1.04021*85./324.*(1.-np.exp(-2.*lncs)) + 1.21041*10./243.*(-c3+1.5*np.exp(2.*lncs)*(1.-np.exp(-2.*lncs)))
#        fNL2 = -0.0395140*85./324.*(1.-np.exp(-2.*lncs)) - 0.175685**10./243.*(-c3+1.5*np.exp(2.*lncs)*(1.-np.exp(-2.*lncs)))
...
#### standard deviations ######
	...
	if (self.binningPk>0):
        ...
        fnlc = (cosmo.A_s()**0.5)*1944./625.*np.pi**4.

        phif = (fNL+fNL2)*(18./5.)*(b1-1.)*1.686*bphi*((kint/0.45)**2./Tfunc(kint))
        phif1 = (fNL+fNL2)*(18./5.)*(b1-1.)*1.686*((kint/0.45)**2./Tfunc(kint))

        if fNL==0 and fNL2==0:
                P0inttab = (norm**2.*all_theory[15] +norm**4.*(all_theory[21])+ norm**1.*b1*all_theory[16] +norm**3.*b1*(all_theory[22]) + norm**0.*b1**2.*all_theory[17] +norm**2.*b1**2.*all_theory[23] + 0.25*norm**2.*b2**2.*all_theory[1] +b1*b2*norm**2.*all_theory[30]+ b2*norm**3.*all_theory[31] + b1*bG2*norm**2.*all_theory[32]+ bG2*norm**3.*all_theory[33] + b2*bG2*norm**2.*all_theory[4]+ bG2**2.*norm**2.*all_theory[5] + 2.*css0*norm**2.*all_theory[11]/h**2. + (2.*bG2+0.8*bGamma3*norm)*norm**2.*(b1*all_theory[7]+norm*all_theory[8]))*h**3. + (psh)*Pshot + a0*psh*(kint/0.5)**2.  + fz**2.*b4*kint**2.*(norm**2.*fz**2./9. + 2.*fz*b1*norm/7. + b1**2./5)*(35./8.)*all_theory[13]*h + a2*(1./3.)*(10.**4.)*(kint/0.45)**2.
                P2inttab = (norm**2.*all_theory[18] +  norm**4.*(all_theory[24])+ norm**1.*b1*all_theory[19] +norm**3.*b1*(all_theory[25]) + b1**2.*norm**2.*all_theory[26] +b1*b2*norm**2.*all_theory[34]+ b2*norm**3.*all_theory[35] + b1*bG2*norm**2.*all_theory[36]+ bG2*norm**3.*all_theory[37] + 0.25*b2**2.*all_theory[42] + b2*bG2*all_theory[43] + (bG2**2.)*all_theory[44] + 2.*css2*norm**2.*all_theory[12]/h**2. + (2.*bG2+0.8*bGamma3*norm)*norm**3.*all_theory[9])*h**3. + fz**2.*b4*kint**2.*((norm**2.*fz**2.*70. + 165.*fz*b1*norm+99.*b1**2.)*4./693.)*(35./8.)*all_theory[13]*h + a2*(10.**4.)*(2./3.)*(kint/0.45)**2.
                P4inttab = (norm**2.*all_theory[20] + norm**4.*all_theory[27]+ b1*norm**3.*all_theory[28] + b1**2.*norm**2.*all_theory[29] + b2*norm**3.*all_theory[38] + bG2*norm**3.*all_theory[39] + b1*b2*all_theory[40] + b1*bG2*all_theory[41] + 0.25*b2**2.*all_theory[45] + b2*bG2*all_theory[46] + (bG2**2.)*all_theory[46] +2.*css4*norm**2.*all_theory[13]/h**2.)*h**3. + fz**2.*b4*kint**2.*(norm**2.*fz**2.*210./143. + 30.*fz*b1*norm/11.+b1**2.)*all_theory[13]*h
        else:
                P0inttab = (norm**2.*all_theory[15] +norm**4.*(all_theory[21])+ norm**1.*b1*all_theory[16] +norm**3.*b1*(all_theory[22]) + norm**0.*b1**2.*all_theory[17] +norm**2.*b1**2.*all_theory[23] + 0.25*norm**2.*b2**2.*all_theory[1] +b1*b2*norm**2.*all_theory[30]+ b2*norm**3.*all_theory[31] + b1*bG2*norm**2.*all_theory[32]+ bG2*norm**3.*all_theory[33] + b2*bG2*norm**2.*all_theory[4]+ bG2**2.*norm**2.*all_theory[5] + 2.*css0*norm**2.*all_theory[11]/h**2. + (2.*bG2+0.8*bGamma3*norm)*norm**2.*(b1*all_theory[7]+norm*all_theory[8]))*h**3. + (psh)*Pshot + a0*psh*(kint/0.5)**2.  + fz**2.*b4*kint**2.*(norm**2.*fz**2./9. + 2.*fz*b1*norm/7. + b1**2./5)*(35./8.)*all_theory[13]*h + a2*(1./3.)*(10.**4.)*(kint/0.45)**2. + fnlc*fNL*(h**3.)*(all_theory[51]+b1*all_theory[52]+b1**2.*all_theory[53]+b1*b2*all_theory[60]+b2*all_theory[61]+b1*bG2*all_theory[62]+bG2*all_theory[63]) + 1.*(2.*b1*phif+phif**2.)*all_theory[17]*(h**3.) + 1.*phif*all_theory[16]*(h**3.) + fnlc*fNL2*(h**3.)*(all_theory[75]+b1*all_theory[76]+b1**2.*all_theory[77]+b1*b2*all_theory[84]+b2*all_theory[85]+b1*bG2*all_theory[86]+bG2*all_theory[87])
                P2inttab = (norm**2.*all_theory[18] +  norm**4.*(all_theory[24])+ norm**1.*b1*all_theory[19] +norm**3.*b1*(all_theory[25]) + b1**2.*norm**2.*all_theory[26] +b1*b2*norm**2.*all_theory[34]+ b2*norm**3.*all_theory[35] + b1*bG2*norm**2.*all_theory[36]+ bG2*norm**3.*all_theory[37] + 0.25*b2**2.*all_theory[42] + b2*bG2*all_theory[43] + (bG2**2.)*all_theory[44] + 2.*css2*norm**2.*all_theory[12]/h**2. + (2.*bG2+0.8*bGamma3*norm)*norm**3.*all_theory[9])*h**3. + fz**2.*b4*kint**2.*((norm**2.*fz**2.*70. + 165.*fz*b1*norm+99.*b1**2.)*4./693.)*(35./8.)*all_theory[13]*h + a2*(10.**4.)*(2./3.)*(kint/0.45)**2.+ fnlc*fNL*(h**3.)*(all_theory[54]+b1*all_theory[55]+b1**2.*all_theory[56]+b1*b2*all_theory[64]+b2*all_theory[65]+b1*bG2*all_theory[66]+bG2*all_theory[67]) + 1.*phif*all_theory[19]*(h**3.) + fnlc*fNL2*(h**3.)*(all_theory[78]+b1*all_theory[79]+b1**2.*all_theory[80]+b1*b2*all_theory[88]+b2*all_theory[89]+b1*bG2*all_theory[90]+bG2*all_theory[91])
                P4inttab = (norm**2.*all_theory[20] + norm**4.*all_theory[27]+ b1*norm**3.*all_theory[28] + b1**2.*norm**2.*all_theory[29] + b2*norm**3.*all_theory[38] + bG2*norm**3.*all_theory[39] + b1*b2*all_theory[40] + b1*bG2*all_theory[41] + 0.25*b2**2.*all_theory[45] + b2*bG2*all_theory[46] + (bG2**2.)*all_theory[46] +2.*css4*norm**2.*all_theory[13]/h**2.)*h**3. + fz**2.*b4*kint**2.*(norm**2.*fz**2.*210./143. + 30.*fz*b1*norm/11.+b1**2.)*all_theory[13]*h+fnlc*fNL*(h**3.)*(all_theory[57]+b1*all_theory[58]+b1**2.*all_theory[59]+b1*b2*all_theory[68]+b2*all_theory[69]+b1*bG2*all_theory[70]+bG2*all_theory[71]) + fnlc*fNL2*(h**3.)*(all_theory[81]+b1*all_theory[82]+b1**2.*all_theory[83]+b1*b2*all_theory[92]+b2*all_theory[93]+b1*bG2*all_theory[94]+bG2*all_theory[95])
        
        
#        phif = fNL*(18./5.)*(b1-1.)*1.686*bphi*((kint/0.45)**2./Tfunc(kint))
#        phif1 = fNL*(18./5.)*(b1-1.)*1.686*((kint/0.45)**2./Tfunc(kint))
#        P0inttab = (norm**2.*all_theory[15] +norm**4.*(all_theory[21])+ norm**1.*b1*all_theory[16] +norm**3.*b1*(all_theory[22]) + norm**0.*b1**2.*all_theory[17] +norm**2.*b1**2.*all_theory[23] + 0.25*norm**2.*b2**2.*all_theory[1] +b1*b2*norm**2.*all_theory[30]+ b2*norm**3.*all_theory[31] + b1*bG2*norm**2.*all_theory[32]+ bG2*norm**3.*all_theory[3] + b2*bG2*norm**2.*all_theory[4]+ bG2**2.*norm**2.*all_theory[5] + 2.*css0*norm**2.*all_theory[11]/h**2. + (2.*bG2+0.8*bGamma3*norm)*norm**2.*(b1*all_theory[7]+norm*all_theory[8]))*h**3. + (psh)*Pshot + a0*(10**4)*(kint/0.5)**2.  + fz**2.*b4*kint**2.*(norm**2.*fz**2./9. + 2.*fz*b1*norm/7. + b1**2./5)*(35./8.)*all_theory[13]*h + a2*(1./3.)*(10.**4.)*(kint/0.45)**2. + fnlc*fNL*(h**3.)*(all_theory[51]+b1*all_theory[52]+b1**2.*all_theory[53]+0.5*b1*b2*all_theory[60]+0.5*b2*all_theory[61]+b1*bG2*all_theory[62]+bG2*all_theory[63]) + 1.*(2.*b1*phif+phif**2.)*all_theory[17]*(h**3.) + 1.*phif*all_theory[16]*(h**3.)
#        P2inttab = (norm**2.*all_theory[18] +  norm**4.*(all_theory[24])+ norm**1.*b1*all_theory[19] +norm**3.*b1*(all_theory[25]) + b1**2.*norm**2.*all_theory[26] +b1*b2*norm**2.*all_theory[34]+ b2*norm**3.*all_theory[35] + b1*bG2*norm**2.*all_theory[36]+ bG2*norm**3.*all_theory[37]  + 2.*css2*norm**2.*all_theory[12]/h**2. + (2.*bG2+0.8*bGamma3*norm)*norm**3.*all_theory[9])*h**3. + fz**2.*b4*kint**2.*((norm**2.*fz**2.*70. + 165.*fz*b1*norm+99.*b1**2.)*4./693.)*(35./8.)*all_theory[13]*h + a2*(10.**4.)*(2./3.)*(kint/0.45)**2.+ fnlc*fNL*(h**3.)*(all_theory[54]+b1*all_theory[55]+b1**2.*all_theory[56]+0.5*b1*b2*all_theory[64]+0.5*b2*all_theory[65]+b1*bG2*all_theory[66]+bG2*all_theory[67])+ 1.*phif*all_theory[19]*(h**3.)
#        P4inttab = (norm**2.*all_theory[20] + norm**4.*all_theory[27]+ b1*norm**3.*all_theory[28] + b1**2.*norm**2.*all_theory[29] + b2*norm**3.*all_theory[38] + bG2*norm**3.*all_theory[39]  +2.*css4*norm**2.*all_theory[13]/h**2.)*h**3. + fz**2.*b4*kint**2.*(norm**2.*fz**2.*210./143. + 30.*fz*b1*norm/11.+b1**2.)*all_theory[13]*h+fnlc*fNL*(h**3.)*(all_theory[57]+b1*all_theory[58]+b1**2.*all_theory[59]+0.5*b1*b2*all_theory[68]+0.5*b2*all_theory[69]+b1*bG2*all_theory[70]+bG2*all_theory[71])
        ...
        Ebp0 = (2.*b1*phif1+2.*phif1*phif)*all_theory[17]*(h**3.) + phif1*all_theory[16]*(h**3.)
        Ebp2 = phif1*all_theory[19]*(h**3.)
        ...
        Ebpcov = np.zeros(3*self.ksizep0p2+self.ksizemu0+self.ntriag+2)

        P0int1 = interpolate.InterpolatedUnivariateSpline(kint,P0inttab,ext=3)
        ...
        Ebp0int = interpolate.InterpolatedUnivariateSpline(kint,Ebp0,ext=3)
        Ebp2int = interpolate.InterpolatedUnivariateSpline(kint,Ebp2,ext=3)

        integr0bG3 = lambda k: exp(3.*k)*E0bG3int(exp(k))
        integr2bG3 = lambda k: exp(3.*k)*E2bG3int(exp(k))
        integrand0 = lambda k: exp(3.*k)*P0int1(exp(k))
        ...
        integrandEbp0 = lambda k: exp(3.*k)*Ebp0int(exp(k))
        integrandEbp2 = lambda k: exp(3.*k)*Ebp2int(exp(k))
        ...
        Ebp0th = np.zeros(self.ksize2)
        Ebp2th = np.zeros(self.ksize2)
	...
	#print('Beginning of 0th integration')
            for i in range(self.ksize2):
                ...
                Ebp0th[i] = integrate.quad(integrandEbp0, log(dk2*i+self.kmin2), log(dk2*(i+1)+self.kmin2))[0]*3./((dk2*(i+1)+self.kmin2)**3.-(dk2*i+self.kmin2)**3.)
                Ebp2th[i] = integrate.quad(integrandEbp2, log(dk2*i+self.kmin2), log(dk2*(i+1)+self.kmin2))[0]*3./((dk2*(i+1)+self.kmin2)**3.-(dk2*i+self.kmin2)**3.)
	else:
		P0th = P0inttab
		P2th = P2inttab
		Ecs0th = Ecs0
        ...
        for i in range(self.ksizep0p2):
            ...
            Ebpcov[i] = Ebp0th[i]
            Ebpcov[i + self.ksizep0p2] = Ebp2th[i]
        ...
        for i in range(self.ksizemu0):
            ...
            Ebpcov[i + 3*self.ksizep0p2] = Ebp0int(self.k2[i + self.ksizep0p2]) - 0.5*Ebp2int(self.k2[i+ self.ksizep0p2])
...
### bispectrum part starts
	...
	EBBshot = np.zeros(self.ntriag);
        ...
        def Bfunc3(k1,k2,k3,mu,phi,kc1=0,kc2=0,kc3=0,apar=1,aperp=1):
                ...
                FF2func1 = zz21*(1+beta*nnu1**2)*(1.+beta*nnu2**2.)*PPres1*kk1*ddk1*PPres2*kk2*ddk2*kk3*ddk3 + 1.*0.5*(Bshot/ng)*b1**2.*PPres1*kk1*(1.+beta*nnu1**2.*(Bshot+1.*(1.+Pshot))/Bshot + beta**2.*nnu1**4.*1.*(1.+Pshot)/Bshot)*kk2*kk3*ddk1*ddk2*ddk3 + ((1.+Pshot)/ng)**2.*kk1*kk2*kk3*ddk1*ddk2*ddk3/2.
                FF2func2 = zz22*(1+beta*nnu1**2)*(1.+beta*nnu3**2.)*PPres1*kk1*ddk1*PPres3*kk3*ddk3*kk2*ddk2 + 1.*0.5*(Bshot/ng)*b1**2.*PPres2*kk2*(1.+beta*nnu2**2.*(Bshot+1.+1.*Pshot)/Bshot + beta**2.*nnu2**4.*1.*(1.+Pshot)/Bshot)*kk1*kk3*ddk1*ddk2*ddk3 + 0.*(1/ng)**2.*kk1*kk2*kk3*ddk1*ddk2*ddk3/6.
                FF2func3 = zz23*(1+beta*nnu2**2)*(1.+beta*nnu3**2.)*PPres2*kk2*ddk2*PPres3*kk3*ddk3*kk1*ddk1 + 1.*0.5*(Bshot/ng)*b1**2.*PPres3*kk3*(1.+beta*nnu3**2.*(Bshot+1.+1.*Pshot)/Bshot + beta**2.*nnu3**4.*1.*(1.+Pshot)/Bshot)*kk2*kk1*ddk1*ddk2*ddk3 + 0.*(1/ng)**2.*kk1*kk2*kk3*ddk1*ddk2*ddk3/6.
        ...
        def EPfunc(k1,k2,k3,mu,phi,kc1=0,kc2=0,kc3=0,apar=1,aperp=1):
                ...
                PPres2 = Pres(kk2*qq2,nnu2)
                PPres3 = Pres(kk3*qq3,nnu3)
                EPfunc = (b1**2.*(1.*beta*nnu1**2.*(1.+beta*nnu1**2.)*PPres1+PPres2*(beta*nnu2**2.)*(1.+beta*nnu2**2.)+ PPres3*(beta*nnu3**2.)*(1.+beta*nnu3**2.)) + 2.*psh*(1.+Pshot))*kk1*kk2*kk3*ddk1*ddk2*ddk3/apar**2./aperp**4.
#		EPfunc = (b1*(2.*beta*nnu1**2.*(1.+beta*nnu1**2.)*PPres1+PPres2*(beta*nnu2**2.*2.)*(1.+beta*nnu2**2.)+ PPres3*(2.*beta*nnu3**2.)*(1.+beta*nnu3**2.) + 2.*psh)*kk1*kk2*kk3*ddk1*ddk2*ddk3)/apar**2./aperp**4.
        ...
        def Bfunc4(k1,k2,k3,mu,phi,kc1=0,kc2=0,kc3=0,apar=1,aperp=1):
                ...
                FF2func2 = zz22*(1+beta*nnu1**2)*(1.+beta*nnu3**2.)*PPres1*kk1*ddk1*PPres3*kk3*ddk3*kk2*ddk2 + 1.*0.5*(Bshot/ng)*b1**2.*PPres2*kk2*(1.+beta*nnu2**2.*(Bshot+1.+1.*Pshot)/Bshot + beta**2.*nnu2**4.*1.*(1.+Pshot)/Bshot)*kk1*kk3*ddk1*ddk2*ddk3 + 0.*(1/ng)**2.*kk1*kk2*kk3*ddk1*ddk2*ddk3/6.
                FF2func3 = zz23*(1+beta*nnu2**2)*(1.+beta*nnu3**2.)*PPres2*kk2*ddk2*PPres3*kk3*ddk3*kk1*ddk1 + 1.*0.5*(Bshot/ng)*b1**2.*PPres3*kk3*(1.+beta*nnu3**2.*(Bshot+1.+1.*Pshot)/Bshot + beta**2.*nnu3**4.*1.*(1.+Pshot)/Bshot)*kk2*kk1*ddk1*ddk2*ddk3 + 0.*(1/ng)**2.*kk1*kk2*kk3*ddk1*ddk2*ddk3/6.
                FF2func1C = zz21*(1+beta*nnu1**2)*(1.+beta*nnu2**2.)*PPres1C*kk1*ddk1*PPres2C*kk2*ddk2*kk3*ddk3 + 1.*0.5*(Bshot/ng)*b1**2.*PPres1C*kk1*(1.+beta*nnu1**2.*(Bshot+1.*(1.+Pshot))/Bshot + beta**2.*nnu1**4.*1.*(1.+Pshot)/Bshot)*kk2*kk3*ddk1*ddk2*ddk3 + ((1.+Pshot)/ng)**2.*kk1*kk2*kk3*ddk1*ddk2*ddk3/2.
                FF2func2C = zz22*(1+beta*nnu1**2)*(1.+beta*nnu3**2.)*PPres1C*kk1*ddk1*PPres3C*kk3*ddk3*kk2*ddk2 + 1.*0.5*(Bshot/ng)*b1**2.*PPres2C*kk2*(1.+beta*nnu2**2.*(Bshot+1.+1.*Pshot)/Bshot + beta**2.*nnu2**4.*1.*(1.+Pshot)/Bshot)*kk1*kk3*ddk1*ddk2*ddk3 + 0.*(1/ng)**2.*kk1*kk2*kk3*ddk1*ddk2*ddk3/6.
                FF2func3C = zz23*(1+beta*nnu2**2)*(1.+beta*nnu3**2.)*PPres2C*kk2*ddk2*PPres3C*kk3*ddk3*kk1*ddk1 + 1.*0.5*(Bshot/ng)*b1**2.*PPres3C*kk3*(1.+beta*nnu3**2.*(Bshot+1.+1.*Pshot)/Bshot + beta**2.*nnu3**4.*1.*(1.+Pshot)/Bshot)*kk2*kk1*ddk1*ddk2*ddk3 + 0.*(1/ng)**2.*kk1*kk2*kk3*ddk1*ddk2*ddk3/6.
