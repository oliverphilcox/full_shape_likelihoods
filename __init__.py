...
class full_shape_spectra(Likelihood_prior):
        ...
        def loglkl(self, cosmo, data):
                ...
                for zi in range(self.nz):
                        ...
                        # Run CLASS-PT
                        all_theory = cosmo.get_pk_mult(k_grid*h,z[zi],len(k_grid))
                        ...
                        if self.use_B:
                                ...
                                bk_theory = BkTheory(self, As, fNL_eq, fNL_orth, apar, aperp, fz[zi], r_bao, k_grid, Pk_lin_table1, Pk_lin_table2, self.inv_nbar[zi], self.gauss_w, self.gauss_w2, self.mesh_mu, nB)
